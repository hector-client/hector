...
/**
 * Provide an {@link OutputStream} which will write to a row. The written data will be split up by chunks of the given chunkSize. Each chunk we get written to own column which will
 * have the chunk number (starting at 0) as column key (Long). 
 *
 */
