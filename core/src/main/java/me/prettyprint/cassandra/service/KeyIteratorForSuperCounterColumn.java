 ...
 */
public class KeyIteratorForSuperCounterColumn<K> implements Iterable<K> {
  ...
  public KeyIteratorForSuperCounterColumn(Keyspace keyspace, String columnFamily, Serializer<K> serializer) {
    this(keyspace, columnFamily, serializer, null, null, MAX_ROW_COUNT_DEFAULT);
  }

  public KeyIteratorForSuperCounterColumn(Keyspace keyspace, String columnFamily, Serializer<K> serializer, int maxRowCount) {
    this(keyspace, columnFamily, serializer, null, null, maxRowCount);
  }
  
  public KeyIteratorForSuperCounterColumn(Keyspace keyspace, String columnFamily, Serializer<K> serializer, K start, K end) {
    this(keyspace, columnFamily, serializer, start, end, MAX_ROW_COUNT_DEFAULT);
  }

  public KeyIteratorForSuperCounterColumn(Keyspace keyspace, String columnFamily, Serializer<K> serializer, K start, K end, int maxRowCount) {
    query = HFactory
      .createRangeSuperSlicesCounterQuery(keyspace, serializer, stringSerializer, stringSerializer)
