...
public class HectorTemplateImpl implements HectorTemplate {
  ...
  public KeyspaceOperator createKeyspaceOperator(Cluster cluster,
    ...
    return HFactory.createKeyspaceOperator(keyspace, cluster,
  ...
  public <K, N> CountQuery<K, N> createCountQuery(Serializer<K> keySerializer,
    ...
    return HFactory.createCountQuery(keyspaceOperator, keySerializer,
        nameSerializer);
  }
   ...
   */
  @Override
  public <K, SN> SuperCountQuery<K, SN> createSuperCountQuery(
   ...
   */
  @Override
  public <K, SN, N> SubCountQuery<K, SN, N> createSubCountQuery(
      Serializer<K> keySerializer, Serializer<SN> superNameSerializer,
      Serializer<N> nameSerializer) {
  ...
  public <K, SN, N, V> MultigetSuperSliceQuery<K, SN, N, V> createMultigetSuperSliceQuery(
      Serializer<K> keySerializer, Serializer<SN> sNameSerializer,
      Serializer<N> nameSerializer, Serializer<V> valueSerializer) {
    return HFactory.createMultigetSuperSliceQuery(keyspaceOperator,
  ...
  public <K, SN, N, V> MultigetSubSliceQuery<K, SN, N, V> createMultigetSubSliceQuery(
      Serializer<K> keySerializer, Serializer<SN> sNameSerializer,
      Serializer<N> nameSerializer, Serializer<V> valueSerializer) {
    return HFactory.createMultigetSubSliceQuery(keyspaceOperator,
        keySerializer, sNameSerializer, nameSerializer, valueSerializer);
  }
   ...
   */
  @Override
  public <K, N, V> RangeSlicesQuery<K, N, V> createRangeSlicesQuery(
      Serializer<K> keySerializer, Serializer<N> nameSerializer,
      Serializer<V> valueSerializer) {
    return HFactory.createRangeSlicesQuery(keyspaceOperator, keySerializer,
        nameSerializer, valueSerializer);
  }
  ...
  public <K, SN, N, V> RangeSuperSlicesQuery<K, SN, N, V> createRangeSuperSlicesQuery(
      Serializer<K> keySerializer, Serializer<SN> sNameSerializer,
      Serializer<N> nameSerializer, Serializer<V> valueSerializer) {
    return HFactory.createRangeSuperSlicesQuery(keyspaceOperator,
        keySerializer, sNameSerializer, nameSerializer, valueSerializer);
  }
  ...
  public <K, N, V> SliceQuery<K, N, V> createSliceQuery(
      Serializer<K> keySerializer, Serializer<N> nameSerializer,
      Serializer<V> valueSerializer) {
    return HFactory.createSliceQuery(keyspaceOperator, keySerializer,
        nameSerializer, valueSerializer);
  }
