...
public class EntityManagerFactoryImpl implements EntityManagerFactory {
    ...
    public EntityManagerFactoryImpl(final PersistenceUnitInfo info, final Keyspace space) {
        if (!info.excludeUnlistedClasses()) {
            ...
            em = new EntityManagerImpl(space, this, info.getProperties().getProperty(PACKAGES_TO_SCAN).split(","));
        }
    }
